...
abstract class AppLocalizations {
  ...
  /// No description provided for @powerTrainingDetails.
  ///
  /// In en, this message translates to:
  /// **'Power training details'**
  String get powerTrainingDetails;
  ...
  /// No description provided for @trainingDeletion.
  ///
  /// In en, this message translates to:
  /// **'Training deletion'**
  String get trainingDeletion;

  /// No description provided for @trainingDeletionText.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @exercisesSets.
  ///
  /// In en, this message translates to:
  /// **'Sets of exercises'**
  String get exercisesSets;
  ...
  /// No description provided for @powerTraining.
  ///
  /// In en, this message translates to:
  /// **'Power training'**
  String get powerTraining;

  /// No description provided for @cardioTraining.
  ///
  /// In en, this message translates to:
  /// **'Cardio training'**
